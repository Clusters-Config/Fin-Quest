...
const LoanCalculator = () => {
  ...
  return (
    <div className="mb-8">
      <h3 className="text-2xl font-semibold text-[#457B9D]">Loan Calculator</h3>
      <div className="mt-4">
      ...
      <div className="mt-4">
        <label className="text-gray-700">Interest Rate (Annual %):</label>
        <input
          type="number"
          value={interestRate}
    ...
    <div className="p-6 bg-gradient-to-r from-[#457B9D] to-[#9ACBD0] min-h-screen">
      ...
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-5xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">What is a Loan?</h2>
        ...
        {/* Types of Loans */}
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Types of Loans</h2>
          <p className="text-gray-700 mt-3">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Impacts of Borrowing</h2>
          <p className="text-gray-700 mt-3">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">How to Manage Loans Effectively</h2>
          <p className="text-gray-700 mt-3">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Additional Considerations When Borrowing</h2>
          <p className="text-gray-700 mt-3">
