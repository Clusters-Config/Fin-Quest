...
const SimpleVsCompoundInterest = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-[#A8DADC] to-[#F1FAEE] min-h-screen">
      {/* Page Title */}
      ...
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-5xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">What is Interest?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Simple Interest</h2>
          <p className="text-gray-700 mt-3">
          ...
          <p className="text-gray-700 mt-3">
            ...
            <ul className="list-inside mt-3 text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Compound Interest</h2>
          <p className="text-gray-700 mt-3">
        ...
        {/* Key Differences */}
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Key Differences Between Simple and Compound Interest</h2>
        ...
        {/* Practical Example */}
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Practical Example</h2>
          <p className="text-gray-700 mt-3">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">When to Use Simple vs. Compound Interest</h2>
          <p className="text-gray-700 mt-3">
