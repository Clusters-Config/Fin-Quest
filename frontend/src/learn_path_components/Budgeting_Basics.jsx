...
const BudgetBasics = () => {
  return (
    <div className="bg-gradient-to-b from-[#A8DADC] to-[#FFFFFF] min-h-screen p-6 flex flex-col justify-between">
      <div>
        <h1 className="text-4xl font-bold text-darkBlue text-center mb-8 animate__animated animate__fadeIn">
          Budget Basics
        </h1>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 mb-8 animate__animated animate__fadeIn">
          ...
          <p className="text-gray-700 whitespace-pre-line mb-6">
            ...
            4. Build good financial habits early. 
          ...
          <p className="text-gray-700 whitespace-pre-line mb-6">
            ...
            1. Write down your income (e.g., allowance, part-time job earnings).
            2. List all your expenses (e.g., snacks, school supplies, hobbies).
            3. Subtract your expenses from your income.
            4. Save the leftover money for future needs or emergencies.
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 mb-8 animate__animated animate__fadeIn">
          ...
          <p className="text-gray-700 whitespace-pre-line mb-6">
            ...
            <ul className="list-disc pl-6">
              <li><a href="https://www.youneedabudget.com" className="text-blue-500 hover:underline">You Need A Budget (YNAB)</a></li>
              <li><a href="https://mint.intuit.com" className="text-blue-500 hover:underline">Mint (Budgeting App)</a></li>
              <li><a href="https://www.daveramsey.com/budgeting" className="text-blue-500 hover:underline">Dave Ramsey's Budgeting Guide</a></li>
            </ul>
          </p>
        </div>
      </div>
  ...
  <Link to="/QuizApp/Budgeting_Basics">
    <button className="bg-[#457B9D] hover:bg-[#A8DADC] text-white px-6 py-3 rounded-lg font-bold text-xl transform transition-all duration-300 hover:scale-105 border-2 border-solid border-[#457B9D] hover:border-[#A8DADC]">
