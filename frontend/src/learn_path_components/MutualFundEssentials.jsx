...
const MutualFundCalculator = () => {
  ...
  return (
    <div className="mb-8">
      <h3 className="text-2xl font-semibold text-[#457B9D]">Mutual Fund Calculator</h3>
      <div className="mt-4">
      ...
      <div className="mt-4">
        <label className="text-gray-700">Rate of Return (Annual %):</label>
        <input
          type="number"
          value={rateOfReturn}
      ...
      <div className="mt-4">
        <label className="text-gray-700">Investment Period (Years):</label>
        <input
          type="number"
          value={years}
    ...
    <div className="p-6 bg-gradient-to-r from-[#457B9D] to-[#9ACBD0] min-h-screen">
      ...
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-5xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">What are Mutual Funds?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Types of Mutual Funds</h2>
          <p className="text-gray-700 mt-3">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">Benefits of Investing in Mutual Funds</h2>
          <p className="text-gray-700 mt-3">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-[#457B9D]">How to Start Investing in Mutual Funds</h2>
          <p className="text-gray-700 mt-3">
