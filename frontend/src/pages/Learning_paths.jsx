            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg border border-white/20 p-6">
                  <h3 className="text-lg font-semibold text-[#002147] mb-4">Continue Learning</h3>
                  <ul className="space-y-4">
                    <li className="flex items-center space-x-4 hover:bg-gray-50 p-3 rounded-lg transition">
                      <div className="relative w-20 h-14 flex-shrink-0 bg-blue-100 rounded-lg flex items-center justify-center">
                        <Play className="w-6 h-6 text-blue-600" />
                      </div>
                      <div>
                        <p className="text-[#002147] font-medium text-sm">Understanding Compound Interest</p>
                        <p className="text-xs text-gray-500">Video · 8 min</p>
                      </div>
                    </li>
                    <li className="flex items-center space-x-4 hover:bg-gray-50 p-3 rounded-lg transition">
                      <div className="relative w-20 h-14 flex-shrink-0 bg-green-100 rounded-lg flex items-center justify-center">
                        <BookOpen className="w-6 h-6 text-green-600" />
                      </div>
                      <div>
                        <p className="text-[#002147] font-medium text-sm">Building an Emergency Fund</p>
                        <p className="text-xs text-gray-500">Article · 5 min</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg border border-white/20 p-6">
                  <h3 className="text-lg font-semibold text-[#002147] mb-4">Your Progress</h3>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">🎓 Courses Completed:</span>
                      <span className="font-semibold text-[#002147]">3</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">⏱️ Hours Learned:</span>
                      <span className="font-semibold text-[#002147]">24</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">📜 Certificates Earned:</span>
                      <span className="font-semibold text-[#002147]">2</span>
                    </div>
                  </div>
                </div>
              </div>
